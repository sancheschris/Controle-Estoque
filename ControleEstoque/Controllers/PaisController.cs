...
namespace ControleEstoque.Controllers
{
    public class PaisController : Controller
    {
        ...
        public PaisController(StockContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PaisID,Nome,Ativo")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaisID,Nome,Ativo")] Pais pais)
        {
            if (id != pais.PaisID)
            {
                return NotFound();
